...
--Select S.Country,Count(S.SupplierName) from suppliers as S group by S.Country
--Select O.OrderID,O.OrderDate,O.CustomerID,Count(OrderID) as 'Say' from orders as O  group by O.OrderID,O.OrderDate,O.CustomerID 
